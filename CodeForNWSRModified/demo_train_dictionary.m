...
clear
clc
addpath('C:\Program Files\MATLAB\R2019b\toolbox\ompbox10');
% addpath('E:\mfiles_acode_thesis\005_ksvd\Kafieh_OCT_Denoising\ompbox10_OCT');
% addpath('E:\THESIS\Implements\Pedagogical');

% Read training images
Nim=10;
train_pth='./datasets/ourDatasets/CreatedImages/onion_without';
Images=load_train_images(train_pth,Nim);

% Parameters
train_D=1; % set 1: to train D (dictionary), set 0: to load D from a file
...
dlfile=sprintf('dictionary_onion.mat',ps(1),ps(2));
